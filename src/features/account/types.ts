...
export interface MeProfile {
  user_id: string; phira_id: number; username: string; avatar?: string | null; status?: string; last_seen_at?: string; created_at?: string; bio?: string; profile_visibility?: 'public' | 'friends' | 'private'
}
